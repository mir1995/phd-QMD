...
as a reminder that we are working in momentum space.
\\
\\
...
\\
\textcolor{red}{How do we detect the avoided crossing?} 
\\
...
\begin{enumerate}
  \item \textbf{Change of basis/co-ordinates} for the Hagedorn wavepackets such that
    a coordinate axis is parallel to $p(t_c)$, the momentum of the wavepacket 
  ...
  $p$ should be enough
    \textcolor{red}{How to detect an avoided crossing in high dimension?}
